...
import (
	...
	"github.com/osbuild/osbuild-installer-backend/internal/server"
...
func main() {
	...
	fmt.Printf("URL: localhost:8086%s/version", swagger.Servers[0].URL)
	Server.Run("localhost:8086", swagger.Servers[0].URL)
}
